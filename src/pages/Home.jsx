...
//             <div className="relative bg-gradient-to-b from-gray-950 to-black w-[80vw] h-[70vh] rounded shadow-[0_0_100px_20px_rgba(255,255,255,0.05)] flex flex-col justify-center items-center">
...
function Home() {
    ...
    return (
        <div>
            ...
            {/* {!isMobile && (
                <div className="h-12 w-screen z-10 fixed top-0 left-0 p-4 flex items-center gap-2 cursor-pointer select-none">
                    <div
                        className="relative w-14 h-7 flex items-center bg-gray-900 border border-gray-700 rounded-full shadow-md"
                        onClick={toggleView}
                    >
                        <div
