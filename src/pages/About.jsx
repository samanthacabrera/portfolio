    ...
    <div className="group flex flex-col items-center">
      <div className="space-y-4 pb-4">
        ...
        <p>
          ...
          I am equal parts 
            <span className="text-yellow-500 md:text-inherit group-hover:text-yellow-500 transition duration-500 delay-300"> developer </span> 
            and 
