...
const Resume = () => {
    ...
    return (
        ...
        <a
            ...
            className="px-4 py-2 bg-gray-200 text-gray-800 text-sm rounded-lg shadow transition-transform transform hover:scale-105 hover:bg-gray-200 focus:outline-none focus:shadow-outline"
        >
            Download Resume
        </a>
        </div>

        {/* <section id="resume" className="hidden md:block max-w-4xl mx-auto p-6 bg-white bg-opacity-70 shadow-md rounded-md mt-8 text-gray-500 text-left">
