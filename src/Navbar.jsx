...
//         <div className="pointer-events-auto absolute top-4 left-4 hidden sm:flex space-x-4">
...
//           </a>
//         </div>
//         <div className="pointer-events-auto absolute top-4 left-4 sm:hidden">
...
//           </button>
//         </div>
//         <div className="pointer-events-auto absolute top-4 right-4 hidden sm:flex space-x-4">
...
//       {isMenuOpen && (
//         <div className="fixed inset-0 bg-gray-200 bg-opacity-10 text-lg text-gray-600 flex flex-col justify-center items-center z-50">
