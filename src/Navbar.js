...
const Navbar = () => {
  ...
  const navbarClass = `navbar ${showNavbar ? 'opacity-1' : 'opacity-0'} fixed bottom-0 w-full backdrop-blur-sm transition duration-300 ease-in-out`;

  return (
    <nav className={navbarClass} >
      <div className="flex flex-row items-center justify-between px-4">
        <a id="homeIcon" href="/" className="uppercase">Sam<span className="text-red-400 inline-block transform hover:translate-y-[-2px] hover:rotate-6 transition duration-300 ease-in-out"> Cab</span></a>
        <div className="flex flex-row items-center space-x-20 py-2">
          <a href="https://linkedin.com/in/samcabreraa" target="_blank" rel="noopener noreferrer" className="icon-link transform hover:-translate-y-1 transition duration-300 ease-in-out">
            <FontAwesomeIcon icon={faLinkedin} size="2x" />
          </a>
          <a href="https://github.com/samanthacabrera" target="_blank" rel="noopener noreferrer" className="icon-link transform hover:-translate-y-1 transition duration-300 ease-in-out">
            <FontAwesomeIcon icon={faGithub} size="2x" />
          </a>
          <a href="https://codepen.io/samanthacabrera" target="_blank" rel="noopener noreferrer" className="icon-link transform hover:-translate-y-1 transition duration-300 ease-in-out">
            <FontAwesomeIcon icon={faCodepen} size="2x" />
          </a>
          <a href="https://open.spotify.com/user/samantha.n.cabrera?si=mAb874ggRgu9g60cUOlMPw" target="_blank" rel="noopener noreferrer" className="icon-link transform hover:-translate-y-1 transition duration-300 ease-in-out">
            <FontAwesomeIcon icon={faSpotify} size="2x" />
          </a>
        </div>
        <a href="/about">About</a>
